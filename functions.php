...
if ( ! function_exists( 'theory_setup' ) ) :
	/**
	...
	function theory_setup() {
		...
		register_nav_menus( array(
			'primary-menu' => esc_html__( 'Primary', 'theory' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'theory_custom_background_args', array(
...
function theory_scripts() {
	wp_enqueue_style( 'theory-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'util.js', get_template_directory_uri() . '/assets/js/util.js', array(), '20151215', true );
	wp_enqueue_script( 'main.js', get_template_directory_uri() . '/assets/js/main.js', array(), '20151215', true );
	
	
	// wp_enqueue_script( 'theory-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	// wp_enqueue_script( 'theory-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
